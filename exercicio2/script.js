...
const triplo = num.map((numeros) =>{
    return numeros * 3
})
console.log("Array com o valor triplicado(3X) do valor do array original:", triplo);

const metade = num.map((numeros)=>numeros/2)
console.log("Array com valor pela metade (%2):", metade);